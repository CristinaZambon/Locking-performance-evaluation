...
{   int num_thread = 2;
    ...
    { Pthread_create (&pts[j], NULL, &thread_function_insert, list);
    }
    ...
    printf("Evaluating the one-lock-per list implementation with the 1st workload: the threads terminate after: %f (seconds)\n\n",
